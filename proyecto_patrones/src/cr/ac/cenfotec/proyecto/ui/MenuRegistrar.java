...
import com.encriptacion.manager.*;
import com.encriptacion.objects.*;
import com.encriptacion.*;
public class MenuRegistrar extends MenuPrincipal {

	@Override
	public void menu() {
		imprimir.println("1. Registrar firma.");
	...
	public void registrarFirma() throws Exception {
		...
		em.initEncrypt(TypeEncript.AES);
		...
		em.encryptMessage(nombre, mensaje, llave);
